  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="max-w-lg mx-auto w-full px-4 py-16 text-center">
        <h1 className="text-3xl font-extrabold">Technician accounts are by invitation</h1>
        <p className="text-[var(--text3)] mt-3 mb-8">
          Field engineers and service techs join through their repair company&apos;s Team page.
