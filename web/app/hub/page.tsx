  ...
  const techCards: HubCard[] = owner
    ...
    : supplier
      ...
      : [
          ...
          { href: '/manuals', icon: '📚', label: 'Service Manuals', desc: 'Service & technical bookshelf' },
          { href: '/manuals?lib=operators', icon: '📖', label: 'Operators Manuals', desc: 'Operators, IFU & user docs' },
